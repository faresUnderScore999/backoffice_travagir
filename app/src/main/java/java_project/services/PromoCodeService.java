...
public class PromoCodeService {
    ...
    /**
     * Fetches promo codes associated with a specific offer.
     * Endpoint: GET /api/v1/promocodes/offer/{offerId}
     */
    public CompletableFuture<HttpResponse<String>> getPromoCodesByOffer(int offerId) {
        return apiClient.sendWithRetry("/api/v1/promocodes/offer/" + offerId, "GET", null);
    }
